...
class CommentsHandler {
    ...
    create(comment) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.post('/activity/comment', comment);
            return response.data;
        });
    }
    update(comment_activity_id, comment) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.patch(`/activity/comment/${encodeURI(comment_activity_id)}`, {
                comment,
            });
            return response.data;
        });
    }
    delete(comment_activity_id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.delete(`/activity/comment/${encodeURI(comment_activity_id)}`);
        });
    }
}
...
class FieldsHandler {
    ...
    readOne(collection, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/fields/${collection}/${id}`);
            return response.data;
        });
    }
    readMany(collection) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/fields/${collection}`);
            return response.data;
        });
    }
    readAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/fields`);
            return response.data;
        });
    }
    createOne(collection, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.transport.post(`/fields/${collection}`, item)).data;
        });
    }
    updateOne(collection, field, item) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    deleteOne(collection, field) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.delete(`/fields/${collection}/${field}`);
        });
    }
}
...
class RelationsHandler {
    ...
    readOne(collection, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/relations/${collection}/${id}`);
            return response.data;
        });
    }
    readMany(collection) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/relations/${collection}`);
            return response.data;
        });
    }
    readAll() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.transport.get(`/relations`);
            return response.data;
        });
    }
    createOne(item) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.transport.post(`/relations`, item)).data;
        });
    }
    updateOne(collection, field, item) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.transport.patch(`/relations/${collection}/${field}`, {
                params: item,
            })).data;
        });
    }
    deleteOne(collection, field) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.delete(`/relations/${collection}/${field}`);
        });
    }
}
...
class ServerHandler {
    ...
    ping() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.transport.get('/server/ping')).raw;
        });
    }
    info() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.transport.get('/server/info')).data;
        });
    }
}
...
class SingletonHandler {
    ...
    read(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.transport.get(`${this.endpoint}`, {
                params: query,
            });
            return item.data;
        });
    ...
    update(data, _query) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.transport.patch(`${this.endpoint}`, data, {
                params: _query,
            });
            return item.data;
        });
...
class InvitesHandler {
    ...
    send(email, role, invite_url) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post('/users/invite', {
                email,
                role,
                invite_url,
            });
    ...
    accept(token, password) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post(`/users/invite/accept`, {
                token,
                password,
            });
        });
...
class TFAHandler {
    ...
    generate(password) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.transport.post('/users/me/tfa/generate', { password });
            return result.data;
        });
    }
    enable(secret, otp) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post('/users/me/tfa/enable', { secret, otp });
        });
    }
    disable(otp) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post('/users/me/tfa/disable', { otp });
        });
    }
}
...
class MeHandler {
    ...
    read(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._transport.get('/users/me', {
                params: query,
            });
            return response.data;
        });
    ...
    update(data, query) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._transport.patch(`/users/me`, data, {
                params: query,
            });
            return response.data;
        });
...
class PasswordsHandler {
    ...
    request(email, reset_url) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post('/auth/password/request', { email, reset_url });
        });
    }
    reset(token, password) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.transport.post('/auth/password/reset', { token, password });
        });
    }
}
...
class GraphQLHandler {
    ...
    request(base, query, variables) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.transport.post(base, {
                query,
    ...
    items(query, variables) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.request('/graphql', query, variables);
        });
    }
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    system(query, variables) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.request('/graphql/system', query, variables);
        });
    }
}
...
class Directus {
    constructor(url, options) {
        this._storage = (options === null || options === void 0 ? void 0 : options.storage) || (typeof window !== 'undefined' ? new LocalStorage() : new MemoryStorage());
        this._transport =
            (options === null || options === void 0 ? void 0 : options.transport) ||
                new AxiosTransport(url, this._storage, () => __awaiter(this, void 0, void 0, function* () {
                    yield this._auth.refresh();
                }));
        this._auth = (options === null || options === void 0 ? void 0 : options.auth) || new Auth(this._transport, this._storage);
        this._items = {};
        this._singletons = {};
    }
    get auth() {
...
export { ActivityHandler, Auth, AxiosTransport, BaseStorage, CollectionsHandler, CommentsHandler, Directus, FieldsHandler, FilesHandler, FoldersHandler, ItemsHandler, LocalStorage, MemoryStorage, Meta, PermissionsHandler, PresetsHandler, RelationsHandler, RevisionsHandler, RolesHandler, ServerHandler, SettingsHandler, TransportError, UsersHandler, UtilsHandler };
